...
<!--            <td style="border: solid"><p> le prix </p>--><?php //formatPrice($array[$i]['produit']['prix'])?><!--</td>-->
<!--            <td style="border: solid"><p> le prix </p>--><?php //priceExcludingVAT(($array[$i]['produit']['prix']))?><!--</td>-->
